...
def main(caminho_excel):
    ...
    #----------------------------------------------------------------------------------------------------------------------
        ...
        Desenho_Maquina(d, Maquina, posicao_elementos, dicionario_cores, Barra)

    #----------------------------------------------------------------------------------------------------------------------
    #-------------------------------------- INSERE OS TRANSFORMADORES -----------------------------------------------------
    #----------------------------------------------------------------------------------------------------------------------

        Desenho_Transformador(d, Transformador, posicao_elementos, dicionario_cores, Barra)

    #----------------------------------------------------------------------------------------------------------------------
    #----------------------------------- INSERE AS LINHAS DE TRANSMISSÃO --------------------------------------------------
    #----------------------------------------------------------------------------------------------------------------------

        Desenho_Linha(d, Linha, posicao_elementos, dicionario_cores, Barra)

    #----------------------------------------------------------------------------------------------------------------------
    #------------------------------------------ INSERE AS CARGAS ----------------------------------------------------------
    #----------------------------------------------------------------------------------------------------------------------
        
        Desenho_Carga(d, Carga, posicao_elementos, dicionario_cores, Barra)
